...
from twitteruser.views import user_detail_view, index, signup_view, unfollow_view, follow_view
from authentication.views import login_view, logout_view
from tweet.views import tweet_detail_view, create_tweet_view
...
urlpatterns = [
    ...
    path('user_detail_view/<int:tweet_id>/', user_detail_view.as_view(), name="userdetail"),
    path('notification_view/', notification_view.as_view(), name="notification"),
    path('login_view/', login_view, name='login'),
    path('signup_view/', signup_view.as_view(), name='signup'),
